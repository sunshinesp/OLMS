...
namespace olms
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        static int global_current_stock, global_actual_stock, global_issued_books;
             ...
             try
                {
                    ...
                    string filepath = "~/imgs/book_inventory/books1.png";
                    string filename = Path.GetFileName(FileUpload1.PostedFile.FileName);
                    FileUpload1.SaveAs(Server.MapPath("imgs/book_inventory" + filename));
                    filepath = "~/imgs/book_inventory" + filename;
